...
void usage(void)
{
	fputs("capmon - Linux Capabilities Monitor\n"
	      "\n"
	      "USAGE:\n"
	      "        capmon [OPTIONS] COMMAND\n"
	      "        capmon -m [OPTIONS] [PATTERNS]\n"
	      "\n"
	      "COMMAND:\n"
	      ...
	      "OPTIONS:\n"
	      "        -a, --all\n"
	      "            Track ALL capability checks. By default it only tracks to the functions\n"
	      "            `ns_capable` and `capable_wrt_inode_uidgid`. This tracks the central\n"
	      "            `cap_capable` function.\n"
	      "        -m, --monitor\n"
	      "            Use monitor mode.\n"
	      "        -p, --pid <PID>\n"
	      "            Filter output by process ID. Only applicable with -m.\n"
	      "        -c, --capability <CAP>\n"
	      "            Filter output by capability. E.g., CAP_NET_RAW. Only applicable with -m.\n"
	      "        -s, --summary <pid|name>\n"
	      "            Use summary mode. Only applicable with -m.\n"
	      /*"\n"*/
	      ,stderr);
}
